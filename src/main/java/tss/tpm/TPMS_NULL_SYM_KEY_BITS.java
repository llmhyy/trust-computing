...
public class TPMS_NULL_SYM_KEY_BITS extends TpmStructure implements TPMU_SYM_KEY_BITS, TPMU_SYM_MODE, TPMU_SYM_DETAILS, TPMU_SCHEME_KEYEDHASH, TPMU_SIG_SCHEME, TPMU_KDF_SCHEME, TPMU_ASYM_SCHEME, TPMU_SIGNATURE 
{
    ...
    */
    ...
    public static TPMS_NULL_SYM_KEY_BITS fromTpm (byte[] x) 
    {
        TPMS_NULL_SYM_KEY_BITS ret = new TPMS_NULL_SYM_KEY_BITS();
    ...
    public static TPMS_NULL_SYM_KEY_BITS fromTpm (InByteBuf buf) 
    {
        TPMS_NULL_SYM_KEY_BITS ret = new TPMS_NULL_SYM_KEY_BITS();
        ret.initFromTpm(buf);
        return ret;
    ...
    {
        TpmStructurePrinter _p = new TpmStructurePrinter("TPMS_NULL_SYM_KEY_BITS");
