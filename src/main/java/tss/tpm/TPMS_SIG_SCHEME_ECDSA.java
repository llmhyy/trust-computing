...
*/
public class TPMS_SIG_SCHEME_ECDSA extends TpmStructure implements TPMU_SCHEME_KEYEDHASH, TPMU_SIG_SCHEME, TPMU_KDF_SCHEME, TPMU_ASYM_SCHEME, TPMU_SIGNATURE 
{
    /**
    * Most of the ECC signature schemes only require a hash algorithm to complete the definition and can be typed as TPMS_SCHEME_HASH. Anonymous algorithms also require a count value so they are typed to be TPMS_SCHEME_ECDAA.
    * 
    ...
    */
    public TPMS_SIG_SCHEME_ECDSA(TPM_ALG_ID _hashAlg)
    {
        hashAlg = _hashAlg;
    }
    /**
    ...
    */
    ...
    public static TPMS_SIG_SCHEME_ECDSA fromTpm (byte[] x) 
    {
        TPMS_SIG_SCHEME_ECDSA ret = new TPMS_SIG_SCHEME_ECDSA();
    ...
    public static TPMS_SIG_SCHEME_ECDSA fromTpm (InByteBuf buf) 
    {
        TPMS_SIG_SCHEME_ECDSA ret = new TPMS_SIG_SCHEME_ECDSA();
        ret.initFromTpm(buf);
        return ret;
