...
public class TPMS_SIG_SCHEME_RSASSA extends TpmStructure implements TPMU_SCHEME_KEYEDHASH, TPMU_SIG_SCHEME, TPMU_KDF_SCHEME, TPMU_ASYM_SCHEME, TPMU_SIGNATURE 
{
    ...
    */
    ...
    public static TPMS_SIG_SCHEME_RSASSA fromTpm (byte[] x) 
    {
        TPMS_SIG_SCHEME_RSASSA ret = new TPMS_SIG_SCHEME_RSASSA();
    ...
    public static TPMS_SIG_SCHEME_RSASSA fromTpm (InByteBuf buf) 
    {
        TPMS_SIG_SCHEME_RSASSA ret = new TPMS_SIG_SCHEME_RSASSA();
        ret.initFromTpm(buf);
        return ret;
