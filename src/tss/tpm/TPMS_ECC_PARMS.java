 ...
 */
public class TPMS_ECC_PARMS extends TpmStructure implements TPMU_PUBLIC_PARMS, Serializable{
    ...
    public int GetUnionSelector_scheme() {
        if (scheme instanceof TPMS_KEY_SCHEME_ECDH) {
            return 0x0019;
        }
        if (scheme instanceof TPMS_KEY_SCHEME_ECMQV) {
            return 0x001D;
        }
        if (scheme instanceof TPMS_SIG_SCHEME_RSASSA) {
            return 0x0014;
        }
        if (scheme instanceof TPMS_SIG_SCHEME_RSAPSS) {
            return 0x0016;
        }
        if (scheme instanceof TPMS_SIG_SCHEME_ECDSA) {
            return 0x0018;
        }
        if (scheme instanceof TPMS_SIG_SCHEME_ECDAA) {
            return 0x001A;
        }
        if (scheme instanceof TPMS_SIG_SCHEME_SM2) {
            return 0x001B;
        }
        if (scheme instanceof TPMS_SIG_SCHEME_ECSCHNORR) {
            return 0x001C;
        }
        if (scheme instanceof TPMS_ENC_SCHEME_RSAES) {
            return 0x0015;
        }
        if (scheme instanceof TPMS_ENC_SCHEME_OAEP) {
            return 0x0017;
        }
        if (scheme instanceof TPMS_SCHEME_HASH) {
            return 0x7FFF;
        }
        if (scheme instanceof TPMS_NULL_ASYM_SCHEME) {
            return 0x0010;
        }
    ...
    public int GetUnionSelector_kdf() {
        if (kdf instanceof TPMS_SCHEME_MGF1) {
            return 0x0007;
        }
        if (kdf instanceof TPMS_SCHEME_KDF1_SP800_56A) {
            return 0x0020;
        }
        if (kdf instanceof TPMS_SCHEME_KDF2) {
            return 0x0021;
        }
        if (kdf instanceof TPMS_SCHEME_KDF1_SP800_108) {
            return 0x0022;
        }
        if (kdf instanceof TPMS_NULL_KDF_SCHEME) {
            return 0x0010;
        }
        throw new RuntimeException("Unrecognized type");
    }
