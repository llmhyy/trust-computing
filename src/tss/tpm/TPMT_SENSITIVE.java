...
public class TPMT_SENSITIVE extends TpmStructure {
    ...
    public int GetUnionSelector_sensitive() {
        if (sensitive instanceof TPM2B_PRIVATE_KEY_RSA) {
            return 0x0001;
        }
        if (sensitive instanceof TPM2B_ECC_PARAMETER) {
            return 0x0023;
        }
        if (sensitive instanceof TPM2B_SENSITIVE_DATA) {
            return 0x0008;
        }
        if (sensitive instanceof TPM2B_SYM_KEY) {
            return 0x0025;
        }
        if (sensitive instanceof TPM2B_PRIVATE_VENDOR_SPECIFIC) {
            return 0x7FFF;
        }
