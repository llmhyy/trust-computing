...
public class TPMS_SCHEME_KDF1_SP800_56A extends TpmStructure implements TPMU_SCHEME_KEYEDHASH, TPMU_SIG_SCHEME, TPMU_KDF_SCHEME, TPMU_ASYM_SCHEME, TPMU_SIGNATURE 
{
    ...
    */
    ...
    public static TPMS_SCHEME_KDF1_SP800_56A fromTpm (byte[] x) 
    {
        TPMS_SCHEME_KDF1_SP800_56A ret = new TPMS_SCHEME_KDF1_SP800_56A();
    ...
    public static TPMS_SCHEME_KDF1_SP800_56A fromTpm (InByteBuf buf) 
    {
        TPMS_SCHEME_KDF1_SP800_56A ret = new TPMS_SCHEME_KDF1_SP800_56A();
        ret.initFromTpm(buf);
        return ret;
